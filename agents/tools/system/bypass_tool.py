...
class ConversationalBypass(BaseTool):
    ...
    Allows the agent to actively "choose" to just chat without firing real backend logic.
    """
    def __init__(self):
        self.name = "conversational_bypass"
        self.description = "Use this tool ONLY for casual chat, greetings, jokes, asking for clarification, or recapping the conversation."
    ...
    def execute(self, **kwargs) -> str:
        ...
        # nudging the Synthesizer to rely on its RAM context window.
